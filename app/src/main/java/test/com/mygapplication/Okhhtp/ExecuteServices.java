package test.com.mygapplication.Okhhtp;
  ...
  public  interface OnServiceExecute{
    ...
    public void execute(@NonNull String url, @NonNull final OnServiceExecute mOnServiceExecute)  {
        if(!isConnected(AppController.getAppContext())){
            mOnServiceExecute.onServiceExecutedFailed(AppController.getAppContext().getString(R.string.no_network));
            return;
        ...
        AppController.httpClient.newCall(request)
                .enqueue(new Callback() {
                             ...
                             public void onFailure(Call call, IOException e) {
                                 ...
                                 mOnServiceExecute.onServiceExecutedFailed(AppController.getAppContext().getString(R.string.error));
                             }
